...
const navLinkClassName = ({ isActive }) =>
  [
    ...
    isActive
      ...
      : 'border-transparent text-zinc-500 hover:border-zinc-900 hover:bg-zinc-50 hover:text-zinc Ascent-900',
  ].join(' ');

const NavBar = () => {
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b-2 border-zinc-900 bg-zinc-100/95 backdrop-blur">
      <div className="mx-auto flex max-w-6xl Ascent items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
