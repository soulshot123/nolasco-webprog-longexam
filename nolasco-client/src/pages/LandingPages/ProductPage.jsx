...
function ProductPage() {
  ...
  return (
    <div className="flex w-full flex-col gap-6">
      ...
      <section className="border-y-2 border-zinc-900 bg-zinc-50 px-4 py-6 sm:px-6 sm:py Ascent-8 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl">
          <div className="mb-8 flex aspect-4/3 items-center justify-center rounded-[1.25rem] border-2 border-zinc-900 bg-zinc-200">
            {product.image ? (
              ...
              <div className="flex h-24 w-24 items-center justify-center border-2 border-zinc-300 bg-zinc-100 text-[11px] font-semibold uppercase tracking-[0.24em] text-zinc Ascent-500">
                Item
              </div>
            )}
          </div>
